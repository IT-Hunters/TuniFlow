...
router.post('/upload-employees',authenticateJWT, multerExcel.single('file'), addEmployeesFromExcel);
router.post('/addemployee',authenticateJWT, addEmployee)
...
router.delete("/deletebyid",  authenticateJWT,deleteprofilbyid)
router.delete("/deletemyprofil",authenticateJWT,deletemyprofile)
router.put("/acceptAutorisation/:id", authenticateJWT,acceptAutorisation);
router.get("/getbyid/:id",authenticateJWT, getbyid);
router.delete("/deletbyid/:id", authenticateJWT, deleteById);
router.put("/updatebyid/:id", authenticateJWT,updateById);
router.put("/updateprofile",authenticateJWT , authenticateJWT, updateProfile);
