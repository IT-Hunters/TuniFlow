...
module.exports = {
    ...
    getProjectStats,
    getbyid,assignFinancialManagerToProject,assignRHManagerToProject,unassignRHManagerFromProject,unassignFinancialManagerFromProject,unassignAccountantFromProject,
    unassignRHManagerFromProject,unassignFinancialManagerFromProject,unassignAccountantFromProject,
    getProjectById,getMyProject,getbyid,getProjectByUserId,
    getAllAccountantsofproject,getAllHRsOfProject,getAllFinancialManagersOfProject,
    assignRHManagerToProject,updateproject,generateProjectReport,generateProjectReportbyid,generateProjectsReportowner,
    assignFinancialManagerToProject,getAssignedUsersToProject,
    unassignRHManagerFromProject,deleteProjectById,
    unassignFinancialManagerFromProject,
    ...
    getAllAccountantsofproject,getAllHRsOfProject,getAllFinancialManagersOfProject,
    assignRHManagerToProject,updateproject,generateProjectReport,generateProjectReportbyid,generateProjectsReportowner,
    assignFinancialManagerToProject,getAssigned