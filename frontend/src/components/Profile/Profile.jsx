...
<button className="Btn">Edit 
  ...
  {/* Replace the existing balance-card div with this */}
      ...
      <div className="title">
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            <path d="M3 6v18h18v-18h-18zm5 14h-2v-10h2v10zm4 0h-2v-14h2v14zm4 0h-2v-6h2v6z"/>
          </svg>
        </span>
        <p className="title-text">Current Projects</p>
      </div>
